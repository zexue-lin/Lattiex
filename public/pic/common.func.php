...
function encrypt($string,$operation,$key=''){
    ...
    $key_length=strlen($key);
      $string=$operation=='D'?base64_decode($string): common . func . phpsubstr(md5($string . $key), 0, 8) . $string;
    ...
    if($operation=='D'){
        if(substr($result,0,8)==substr(md5(common . func . phpsubstr($result, 8) . $key),0,8)){
