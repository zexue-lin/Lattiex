          ...
          <div class="col-md-12">
            ...
            <div class="row justify-content-center" id="alert" style="display: none">
              <div class="col-lg-8 alert-box-success">
                <div class="alert wow fadeInUp alert-warning alert-dismissible fade show" role="alert">
                  ...
                  <div class="col text-right text-xs-right">
                    <ul class="list-inline mb-0">
                      <div class="btn-group btn-action-label" role="group" aria-label="Like">
                        <a type="button" class="btn btn-sm btn-secondary btn-action" onclick="likeRequest({{ $posts->id }})">
                          <i class="fas fa-thumbs-up"></i>
                          <span>Like</span>
                        </a>
                        <span class="btn btn-sm btn-outline-secondary btn-label" id="likeCount{{$posts->id}}">{{$posts->like}}</span>
                      </div>
                    </ul>
                  </div>
                </div>
              ...
              <div class="card">
                ...
                <div class="list-group">
                  ...
                  <div style="display: flex;flex-direction: column;">
                    <a type="button" class="btn btn-md btn-outline-secondary btn-icon" href="{{url('user/login')}}">
                  ...
                  <a href="#" class="list-group-item list-group-item-action d-flex align-items-center comment-item" onclick="return false;">
                    <div class="list-group-img">
                      <img class="avatar bg-purple" src="{{URL::asset('uploads/'.$item->avatar)}}" alt="用户头像"></img>
                    </div>
                ...
                <div class="card-footer">
                  ...
                  <div style="display: flex;flex-direction: column;margin-bottom: 20px;">
                    <button type="button" class="btn btn-sm btn-outline-primary btn-icon" id="loadMore">
                      <span class="btn-inner--text">查看剩下的{{$comment->count()-5}}条全部评论</span>
      ...
      <div class="col-lg-3">
        <div class="card">
          <div class="card-footer">
            <div class="row align-items-center">
              <div class="col">
                <img class="avatar avatar-md bg-purple" src="{{ config('app.url') . '/uploads/'.( $AuthorInfo->avatar) }}" alt="作者头像" />
