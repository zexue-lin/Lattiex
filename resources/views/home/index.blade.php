            ...
            <div class="content-inner content-docs">
                <div class="pt-3 pb-4 mb-4 border-bottom">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <h2 class="heading h2 font-weight-bold">Welcome to 翻斗花园！</h2>
                    ...
                    <div class="col-lg-9">
                                   ...
                                   style="text-decoration: none;" target="_blank">
                                    <div class="card-body">
                                        ...
                                        <div class="list-inline mb-1">
                                            <div>
                                                <li class="list-inline-item pr-2" {{$item->like}}>
                                                    <i class="fas fa-heart mr-1"
                                                       style="color: red"></i>{{$item->like}}
                                                </li>
                        ...
                        <div class="card" style="margin-bottom: 20px">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">我的发，啥时候才能给我涨工资</p>
                            </div>
